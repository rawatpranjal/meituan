"""
Static Bipartite Matching Baseline Model (Tier 1)
Batch-wise Minimum Cost One-to-One Assignment
Cost Function: Distance to Pickup (simplest baseline)

This script now uses the modular simulator components for proper stateful simulation.
"""
...
print("="*80)
print("STATIC BIPARTITE MATCHING BASELINE MODEL (Using Simulator)")
print("="*80)
...
def run_simulation_with_viz():
    ...
    print("\n" + "="*80)
    print("BASELINE MODEL COMPLETE (TIER 1)")
    print("="*80)

    print("\nKEY FINDINGS:")
    print("- Tier 1 baseline: Cost = Euclidean distance from courier to restaurant")
    print("- Uses Euclidean distance for shifted planar coordinates (PDF Sec 2.1)")
