#!/usr/bin/env python3
"""Test Hungarian algorithm on all scenarios"""
import sys
import os
...
log_file_path = os.path.join(log_dir, f"test_hungarian_all_scenarios_{timestamp}.log")
...
try:
    ...
    print("="*80)
    print("HUNGARIAN ALGORITHM - ALL SCENARIOS TEST")
    print("="*80)
    ...
    for i, config_path in enumerate(scenarios, 1):
        ...
        detailed_log_path = os.path.join(log_dir, f"hungarian_{scenario_name}_detailed_{timestamp}.log")
        export_detailed_log(state, 'hungarian', detailed_log_path)
    ...
    print("="*80)
    print("SUMMARY - HUNGARIAN ALGORITHM ACROSS ALL SCENARIOS")
    print("="*80)
