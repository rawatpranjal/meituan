...
class DistanceToPickup(BaseCostFunction):
    ...
    def compute_cost(self, courier: Dict[str, Any], order: Dict[str, Any],
        ...
        Args:
            courier: Courier dict with lat/lng or rider_lat/rider_lng (both supported)
        ...
        courier_lng = courier.get('lng') if courier.get('lng') is not None else courier.get('rider_lng')
